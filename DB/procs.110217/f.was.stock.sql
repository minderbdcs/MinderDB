...
*/
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'start product stock ');
   ...
   BEGIN
      ...
      END
   END
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got wh list  ');
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WH_ID);
   ...
   BEGIN
      ...
      END
   END
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got company list  ');
wk_log_result = file_writeln(:WK_LOG_FILENAME, :COMPANY_ID);

   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'start finding product  ');
   /* PROD_ID = IN_PROD_ID; */
   FOR SELECT PROD_ID
       FROM PROD_PROFILE
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got a prod   ');
wk_log_result = file_writeln(:WK_LOG_FILENAME, :PROD_ID);
      AVAILABLE_QTY = NULL; 
      RESERVED_QTY = NULL;
      ONSITE_QTY = NULL;
   ...
   */
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got available qty  ');
   /*
   ...
   */
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'start    first 3 issns available  qty  ');
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got  a iissn available qty  ');
         WK_COUNT = WK_COUNT + 1;
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_COUNT);
         IF (WK_COUNT = 1) THEN
         BEGIN
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'finished first 3 issns available  qty  ');
   ...
   */
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got  reserved qty  ');
   ...
   */
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got  onsite qty  ');
   ...
   */
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got  order qty and picked qty ');
      ...
      WK_PICKED_QTY = 0;
      WK_ORDER_QTY = 0;
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'finished picked qty ');
   /*
              AND PICK_ORDER.COMPANY_ID = :COMPANY_ID
              AND PICK_ORDER.WH_ID = :WH_ID
   */
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got HD  order qty and picked qty ');
      IF (WK_ORDER_QTY IS NULL) THEN
      BEGIN
         WK_ORDER_QTY = 0;
      END
...
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'finished picked qty ');
   ...
   */
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got CN  order qty and picked qty ');
      IF (WK_ORDER_QTY IS NULL) THEN
      BEGIN
         WK_ORDER_QTY = 0;
      END
...
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'finished picked qty ');
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got PO   order qty CF and OP  ');
      IF (WK_ORDER_QTY IS NULL) THEN
      BEGIN
         WK_ORDER_QTY = 0;
      END
      ...
      WK_PICKED_QTY = 0;
      WK_ORDER_QTY = 0;
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'finished po qty ');
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got 1st PO   order  CF and OP  ');
   ...
   */
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'got test qty TS  ');
   ...
   WK_LOG_BUFFER = CAST( CAST('NOW' AS TIMESTAMP) AS CHAR(26));
wk_log_result = file_writeln(:WK_LOG_FILENAME, :WK_LOG_BUFFER);
wk_log_result = file_writeln(:WK_LOG_FILENAME, 'finished test qty  ');
