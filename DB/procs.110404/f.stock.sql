...
allow for 100
*/
/*Frank Leih 06 APR 2011
the available qty must exclude the on pick order qty
*/
   ...
   */
      ...
      AVAILABLE_QTY = AVAILABLE_QTY - UNPICKED_ORDER_QTY;
      /* remove on order from the available qty */
