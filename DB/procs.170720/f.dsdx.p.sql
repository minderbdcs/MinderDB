...
DECLARE VARIABLE WK_HAVE_DC       VARCHAR(1);
DECLARE VARIABLE WK_FOUND_DC      INTEGER;
...
*/
    ...
    BEGIN
       ...
       AND   PICK_DETAIL_STATUS = 'DC'
       INTO :WK_FOUND_DC;
       IF ( COALESCE(:WK_FOUND_DC, 0) > 0) THEN
       BEGIN
          WK_HAVE_DC = 'T';
       END
          ...
          BEGIN
             ...
             BEGIN
                ...
                BEGIN
                   ...
                   EXECUTE PROCEDURE ADD_SSN_HIST('XD', '00000000', :WK_SSN_SSN, 
                ...
                BEGIN
                   ...
                   INSERT INTO TRANSACTIONS_ARCHIVE
                    ...
                    SELECT 'XD', '00000000', :WK_SSN, :TRN_TYPE, 'I', :TRN_DATE, :REFERENCE,
