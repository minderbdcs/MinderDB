DROP TRIGGER RUN_TRANSACTION_NIRM ^
...
DECLARE VARIABLE WK_SSN_TYPE VARCHAR(50);
DECLARE VARIABLE WK_GENERIC VARCHAR(50);
DECLARE VARIABLE WK_BRAND VARCHAR(50);
DECLARE VARIABLE WK_MODEL VARCHAR(50);
...
DECLARE VARIABLE WK_DESCRIPTION VARCHAR(80);
