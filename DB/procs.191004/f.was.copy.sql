ALTER TABLE TEST_QUESTIONS ADD ORIGINAL_QUESTION_ID INTEGER^


CREATE INDEX TEST_QUESTIONS_ORIGINALINDEX ON TEST_QUESTIONS(ORIGINAL_QUESTION_ID)^

/*
ALTER  PROCEDURE COPY_QUESTIONS (WK_FROM_TYPE VARCHAR(40), WK_TO_TYPE VARCHAR(40))
*/
CREATE PROCEDURE COPY_QUESTIONS (WK_FROM_TYPE VARCHAR(40), WK_TO_TYPE VARCHAR(40))
AS 
