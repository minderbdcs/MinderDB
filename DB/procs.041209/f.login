...
CREATE PROCEDURE LOGIN_DEVICE (IP_ADDRESS VARCHAR(20), COMPUTER_NAME VARCHAR(50), USER_ID VARCHAR(10)) RETURNS(DEVICE_ID CHAR(2), LG_STATUS INTEGER, LG_MESSAGE VARCHAR(80))
AS 
 
DECLARE VARIABLE WK_USER VARCHAR(10);
DECLARE VARIABLE WK_FOUND INTEGER;
DECLARE VARIABLE WK_IP VARCHAR(20);
