...
*/
        ...
        BEGIN
           /* a product */
           FOR
           SELECT ISSN.WH_ID, ISSN.LOCN_ID, ISSN.CURRENT_QTY, ISSN.ISSN_STATUS, ISSN.SSN_ID
           FROM ISSN 
           WHERE ISSN.PROD_ID = :WK_PI_PROD 
             AND ISSN.WH_ID <> 'XX' AND ISSN.ISSN_STATUS IN ('ST','PA')
           INTO :WK_PI_WH, :WK_PI_LOCN, :WK_PI_QTY, :WK_PI_STATUS, :WK_PROD_SSN
           DO
           BEGIN
              /* update status */
        ...
        BEGIN
           ...
           SELECT ISSN.WH_ID, ISSN.LOCN_ID, ISSN.CURRENT_QTY, ISSN.ISSN_STATUS 
           FROM ISSN 
           WHERE ISSN.SSN_ID = :WK_PI_SSN 
           INTO :WK_PI_WH, :WK_PI_LOCN, :WK_PI_QTY, :WK_PI_STATUS ;
           /* add to devices file */
           WK_LABEL_LINE = 'INSERT INTO PICK_LOCATION (PICK_LABEL_NO, PROD_ID , SSN_ID , WH_ID , LOCN_ID , QTY_AVAILABLE , ISSN_STATUS )  VALUES (' ||
             SQUOTEDSTR(WK_PI_LABEL ) || ',' ||
             SQUOTEDSTR(WK_PI_PROD ) || ',' ||
