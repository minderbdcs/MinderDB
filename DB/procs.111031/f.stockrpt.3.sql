...
CREATE OR ALTER PROCEDURE RPT_PROD_CMP_WH_STOCK_STATUS (IN_PROD_ID VARCHAR(50) CHARACTER SET NONE,
...
SALES_30_DAYS_QTY INTEGER,
SALES_60_DAYS_QTY INTEGER,
SALES_90_DAYS_QTY INTEGER,
SALES_120_DAYS_QTY INTEGER,
ORDERS_30_DAYS_QTY INTEGER,
ORDERS_60_DAYS_QTY INTEGER,
ORDERS_90_DAYS_QTY INTEGER,
ORDERS_120_DAYS_QTY INTEGER)
AS 
...
DECLARE VARIABLE SALESTATUS VARCHAR(40);
...
allow for 100
*/
/*Frank Leih 01 NOV 2011
add 30 60 90 day confirmed product totals for pick items  where pick_order status in  DA DX
*/
...
/* sales for 30 days ago */
      ...
      SELECT SUM( PICK_ITEM.PICK_ORDER_QTY )
              ...
              AND (V4POS(:COMPANY_ID,PICK_ORDER.COMPANY_ID,0,1) > -1)
              AND (POS(:WH_ID,PICK_ORDER.WH_ID,0,1) > -1)
              AND (POS(:SALESTATUS,PICK_ORDER.PICK_STATUS,0,1) > -1)
      ...
      BEGIN
         WK_ORDER_QTY = 0;
      END
      SALES_30_DAYS_QTY = WK_ORDER_QTY ;
      WK_ORDER_QTY = 0;
/* sales for 60 days ago */
      WK_ORDER_QTY = 0;
      SELECT SUM( PICK_ITEM.PICK_ORDER_QTY )
              FROM PICK_ITEM JOIN PICK_ORDER
              ON PICK_ITEM.PICK_ORDER = PICK_ORDER.PICK_ORDER
      ...
      BEGIN
         WK_ORDER_QTY = 0;
      END
      SALES_60_DAYS_QTY = WK_ORDER_QTY ;
      WK_ORDER_QTY = 0;
/* sales for 90 days ago */
      WK_ORDER_QTY = 0;
      SELECT SUM( PICK_ITEM.PICK_ORDER_QTY )
              FROM PICK_ITEM JOIN PICK_ORDER
              ON PICK_ITEM.PICK_ORDER = PICK_ORDER.PICK_ORDER
      ...
      BEGIN
         WK_ORDER_QTY = 0;
      END
      SALES_90_DAYS_QTY = WK_ORDER_QTY ;
      WK_ORDER_QTY = 0;
/* sales for 120 days ago */
      WK_ORDER_QTY = 0;
      SELECT SUM( PICK_ITEM.PICK_ORDER_QTY )
              FROM PICK_ITEM JOIN PICK_ORDER
              ON PICK_ITEM.PICK_ORDER = PICK_ORDER.PICK_ORDER
      ...
      BEGIN
         WK_ORDER_QTY = 0;
      END
      SALES_120_DAYS_QTY = WK_ORDER_QTY ;
      WK_ORDER_QTY = 0;
/* orders for 30 days ago */
      WK_ORDER_QTY = 0;
      ...
      BEGIN
         WK_ORDER_QTY = 0;
      END
      ORDERS_30_DAYS_QTY = WK_ORDER_QTY ;
      WK_ORDER_QTY = 0;
/* orders for 60 days ago */
      WK_ORDER_QTY = 0;
      SELECT COUNT( DISTINCT PICK_ORDER.PICK_ORDER )
              FROM PICK_ITEM JOIN PICK_ORDER
              ON PICK_ITEM.PICK_ORDER = PICK_ORDER.PICK_ORDER
      ...
      BEGIN
         WK_ORDER_QTY = 0;
      END
      ORDERS_60_DAYS_QTY = WK_ORDER_QTY ;
      WK_ORDER_QTY = 0;
/* orders for 90 days ago */
      WK_ORDER_QTY = 0;
      SELECT COUNT( DISTINCT PICK_ORDER.PICK_ORDER )
              FROM PICK_ITEM JOIN PICK_ORDER
              ON PICK_ITEM.PICK_ORDER = PICK_ORDER.PICK_ORDER
      ...
      BEGIN
         WK_ORDER_QTY = 0;
      END
      ORDERS_90_DAYS_QTY = WK_ORDER_QTY ;
      WK_ORDER_QTY = 0;
/* orders for 120 days ago */
      WK_ORDER_QTY = 0;
      SELECT COUNT( DISTINCT PICK_ORDER.PICK_ORDER )
              FROM PICK_ITEM JOIN PICK_ORDER
              ON PICK_ITEM.PICK_ORDER = PICK_ORDER.PICK_ORDER
      ...
      BEGIN
         WK_ORDER_QTY = 0;
      END
      ORDERS_120_DAYS_QTY = WK_ORDER_QTY ;
      WK_ORDER_QTY = 0;
