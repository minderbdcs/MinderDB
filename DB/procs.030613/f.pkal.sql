  ...
  BEGIN
     ...
     FOR 
        SELECT PICK_LABEL_NO, 
               ...
               INTO :WK_PI_LABEL, :WK_PI_PROD, :WK_PI_SSN
     DO
     BEGIN
/*
	must get
...
*/
        ...
        BEGIN
           /* a product */
           FOR
           SELECT ISSN.WH_ID, ISSN.LOCN_ID, ISSN.CURRENT_QTY, ISSN.ISSN_STATUS, SSN.SSN_TYPE, ISSN.SSN_ID
           FROM ISSN 
           ...
           INTO :WK_PI_WH, :WK_PI_LOCN, :WK_PI_QTY, :WK_PI_STATUS, :WK_PI_DESCRIPTION, :WK_PROD_SSN
           DO
           BEGIN
              /* update status */
              UPDATE ISSN SET ISSN_STATUS = 'AL' WHERE SSN_ID = :WK_PROD_SSN;
              /* add to devices file */
              WK_LABEL_LINE = 'INSERT INTO PICK_LOCATION (PICK_LABEL_NO, PROD_ID , SSN_ID , WH_ID , LOCN_ID , QTY_AVAILABLE , DESCRIPTION , ISSN_STATUS )  VALUES (' ||
        ...
        BEGIN
           ...
           SELECT ISSN.WH_ID, ISSN.LOCN_ID, ISSN.CURRENT_QTY, ISSN.ISSN_STATUS, SSN.SSN_TYPE
           FROM ISSN 
                JOIN SSN ON SSN.SSN_ID = ISSN.ORIGINAL_SSN
           WHERE ISSN.SSN_ID = :WK_PI_SSN 
           INTO :WK_PI_WH, :WK_PI_LOCN, :WK_PI_QTY, :WK_PI_STATUS, :WK_PI_DESCRIPTION;
           /* add to devices file */
           WK_LABEL_LINE = 'INSERT INTO PICK_LOCATION (PICK_LABEL_NO, PROD_ID , SSN_ID , WH_ID , LOCN_ID , QTY_AVAILABLE , DESCRIPTION , ISSN_STATUS )  VALUES (' ||
             SQUOTEDSTR(WK_PI_LABEL ) || ',' ||
             SQUOTEDSTR(WK_PI_PROD ) || ',' ||
