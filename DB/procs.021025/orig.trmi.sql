  ...
  BEGIN       
     ...
     */
     ...
     BEGIN
        ...
        DO
        BEGIN
                 EXECUTE PROCEDURE UPDATE_SSN(:str_OBJECT, 'TRMI', :WH_ID); /* Update Warehouse */
                 strAUDIT_DESC = "Warehouse modified";
              /* Add transaction history */                                                                                     
               EXECUTE PROCEDURE ADD_SSN_HIST(:WH_ID, :str_mobile_LOCN_ID, :str_OBJECT, :TRN_TYPE, :TRN_CODE, :TRN_DATE,
