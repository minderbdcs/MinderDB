...
*/
	   ...
	   /* must transfer all of qty always */
           /* Update SSN */ 
           EXECUTE PROCEDURE UPDATE_SSN_TROL_A (:OBJECT, :strWH_ID, :LOCN_ID, :TRN_DATE, :DEVICE_ID);
       ...
       BEGIN
          ...
          EXECUTE PROCEDURE PC_QTY_TROL_TRIL_P (:RECORD_ID, :strWH_ID, strLOCN_ID, :WH_ID, :LOCN_ID, 
  ...
  BEGIN
	...
	/* must remove this qty from issn in transit location */
     ...
     BEGIN
        ...
        EXECUTE PROCEDURE PC_QTY_TROL_TRIL_P (:RECORD_ID, :WH_ID, :LOCN_ID, :strWH_ID, :strLOCN_ID, :OBJECT, :TRN_TYPE, :REFERENCE, :QTY, :PERSON_ID, :DEVICE_ID) 
                                               RETURNING_VALUES :PROCESS_OK; 
