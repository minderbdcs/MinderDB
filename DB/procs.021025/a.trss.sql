  ...
  BEGIN       
     ...
     BEGIN                         
        /* it dosn t make sense to split a product so i ll treat all splits as for an ssn */
           ...
           /* Check From SSN */
           SELECT 1, CURRENT_QTY, ISSN_STATUS, STATUS_CODE, PROD_ID, ORIGINAL_SSN
           FROM ISSN
           WHERE SSN_ID = :OBJECT
           INTO :SSN_EXIST, :iCURRENT_QTY, :strISSN_STATUS, :strISSN_STATUS_CODE, :strPROD_ID , :strORIGINAL_SSN ;
           ...
           BEGIN
              ...
              BEGIN
                 ...
                 INSERT INTO ISSN   
                    ...
                    :TRN_DATE, :strISSN_STATUS, :strISSN_STATUS_CODE, 'NOW', :PERSON_ID, :strPROD_ID );
              END /* new issn */
