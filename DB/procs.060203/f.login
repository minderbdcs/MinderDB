DROP PROCEDURE LOGIN_DEVICE;
ALTER TABLE SYS_EQUIP ADD SAVE_IP VARCHAR(40);
UPDATE SYS_EQUIP SET SAVE_IP = IP_ADDRESS;
COMMIT;
ALTER TABLE SYS_EQUIP DROP IP_ADDRESS;
ALTER TABLE SYS_EQUIP ADD IP_ADDRESS VARCHAR(40);
UPDATE SYS_EQUIP SET IP_ADDRESS = SAVE_IP;
COMMIT;
ALTER TABLE SYS_EQUIP DROP SAVE_IP;
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN     
                ...
                BEGIN
                    /* update - login user */
                    UPDATE SYS_EQUIP SET CURRENT_PERSON = :WK_USER, CURRENT_LOGGED_ON = 'NOW' 
