...
CREATE OR ALTER  PROCEDURE PRODUCT_QTYS 
RETURNS (
PROD_ID PRODUCT ,
...
COMPANY_ID_2 COMPANY 
)
AS 
 

DECLARE VARIABLE WK_PROD_ID PRODUCT;
DECLARE VARIABLE WK_ALTERNATE_ID PRODUCT;
DECLARE VARIABLE WK_COMPANY_ID1 COMPANY;
...
/*    AND (POS(:WK_IMPORT_STATUS,ISSN.ISSN_STATUS,0,1) > -1) */
      ...
      AND (POSITION(ISSN.ISSN_STATUS, :WK_IMPORT_STATUS,1) > 0)
