DROP TRIGGER RUN_TRANSACTION_PLPK^
COMMIT^
...
DECLARE VARIABLE WK_PO_CUSTOMER_PO VARCHAR(15);
DECLARE VARIABLE WK_PD_ADDRESS VARCHAR(50);
     ...
     BEGIN
        ...
        BEGIN
           ...
           BEGIN
              ...
              JOIN PERSON PN ON PN.PERSON_ID = PO.PERSON_ID
              ...
              BEGIN
                  ...
                  WK_LABEL_LINE = DQUOTEDSTR(WK_PI_LABEL) || ',' ||
                      WK_PI_PICK_ORDER_QTY || ',' ||
                      DQUOTEDSTR(WK_PI_PICK_ORDER) || ',' ||
                      DQUOTEDSTR(WK_PO_CUSTOMER_PO) || ',' ||
                      DQUOTEDSTR(WK_PI_PROD_ID) || ',' ||
                      DQUOTEDSTR(WK_PP_DESC) || ',' ||
                      DQUOTEDSTR(WK_PI_CONTACT) || ',' ||
                      DQUOTEDSTR(WK_PD_ADDRESS) || ',' ||
                      DQUOTEDSTR(WK_PI_WH_ID || WK_PI_LOCN_ID) || ',' ||
                      DQUOTEDSTR(SUBSTR(WK_PRINTER,2,2));
