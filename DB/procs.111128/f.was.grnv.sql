...
BEGIN 
   ...
   */
   ...
   EXECUTE PROCEDURE GET_REFERENCE_FIELD :REFERENCE, 9  RETURNING_VALUES :WK_SSNQTY3 ; 
   EXECUTE PROCEDURE GET_REFERENCE_FIELD :REFERENCE, 10  RETURNING_VALUES :WK_LABELQTY3 ; 
   WK_LOG_RESULT = FILE_WRITELN(WK_LOG_FILENAME, 'after split reference');
   IF (WK_SSNQTY1 = '') THEN
   BEGIN
      WK_SSNQTY1 = '0';
   END
