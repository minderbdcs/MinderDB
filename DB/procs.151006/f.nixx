...
CREATE OR ALTER PROCEDURE PC_NIXX (RECORD_ID INTEGER,
...
DECLARE VARIABLE strWH_ID CHAR(2); 
  ...
  DECLARE VARIABLE WK_SN_CREATED_BY   VARCHAR(10);
  DECLARE VARIABLE WK_SN_UPDATED_BY   VARCHAR(10);
...
CREATE OR ALTER PROCEDURE PC_NIXX_P (RECORD_ID INTEGER,
WH_ID CHAR(2) CHARACTER SET NONE,
LOCN_ID VARCHAR(10) CHARACTER SET NONE,
OBJECT VARCHAR(30) CHARACTER SET NONE,
TRN_TYPE VARCHAR(4) CHARACTER SET NONE,
