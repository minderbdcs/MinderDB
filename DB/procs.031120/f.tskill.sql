...
DECLARE VARIABLE WK_LABEL_LINE VARCHAR(265);
...
BEGIN
   ...
   SQUOTEDSTR(WK_CODE) || ',' ||
   SQUOTEDSTR(NONULL(WK_DATE_STR)) || ',' ||
   SQUOTEDSTR(NONULL(WK_BY)) || ',' ||
   SQUOTEDSTR(NONULL(WK_LOCN)) || ',' ||
   SQUOTEDSTR(NONULL(WK_AUTH)) || ',' ||
   SQUOTEDSTR(NONULL(WK_PASS)) || ',' ||
   SQUOTEDSTR(NONULL(WK_TRESULT)) || ',' ||
   SQUOTEDSTR(NONULL(WK_CERT_STR)) || ',' ||
   SQUOTEDSTR(NONULL(WK_COMPULSORY)) ;
