...
/*      WK_TRN_CLASS         = NEW.TRN_CLASS;         Need advice on this */      
      WK_RESPONSE_TEXT      = '' ;
      WK_RESPONSE_FINAL      = '' ;      
      ...
      BEGIN
         IF (EXISTS (SELECT RECORD_ID 
            ...
            INTO :WK_PS_RECORD )) 
         THEN 
            SELECT PS_DESPATCH_ID , PS_AWB_CONSIGNMENT_NO
               FROM PACK_SSCC 
               WHERE PS_SSCC = :WK_OBJECT 
               INTO :WK_DESPATCH_ID, :WK_CONSIGNMENT;
            BEGIN
...
/*            :WK_PS_LAST_UPDATE_BY              */      
         ...
         THEN 
            ...
            BEGIN
               ...
               UPDATE PACK_SSCC
               SET
/*               RECORD_ID                  =:WK_RECORD_ID,               */
               PS_PICK_ORDER                   =:WK_PS_PICK_ORDER,
               PS_PICK_ORDER_LINE_NO          =:WK_PS_PICK_ORDER_LINE_NO,
               PS_PICK_LABEL_NO             =:WK_PS_PICK_LABEL_NO,   
               PS_DESPATCH_ID                  =:WK_PS_DESPATCH_ID,
/*               PS_SSCC                         =:WK_PS_SSCC,               */
               PS_SSCC_STATUS                  ='GO',                     /* 'GO' = Generated Only */
               PS_PICK_ORDER_DATE              =:WK_PS_PICK_ORDER_DATE,
               PS_SCHED_DEL_DATE               =:WK_PS_SCHED_DEL_DATE,
               PS_SCHED_DEL_TIME               =:WK_PS_SCHED_DEL_TIME,
               PS_CARRIER_ID                   =:WK_PS_CARRIER_ID,
               PS_EDI_ASN                        =:WK_PS_EDI_ASN,
               PS_DESPATCHED_DATE                =:WK_PS_DESPATCHED_DATE,
               PS_ORDER_TYPE_CODE                =:WK_PS_ORDER_TYPE_CODE,
               PS_ORDER_TYPE_DESC                =:WK_PS_ORDER_TYPE_DESC,
               PS_PO_PURPOSE_CODE                =:WK_PS_PO_PURPOSE_CODE,
               PS_PO_PURPOSE_DESC                =:WK_PS_PO_PURPOSE_DESC,
               PS_PO_SUBSET_NO                   =:WK_PS_PO_SUBSET_NO,       
               PS_PO_NO_SUBSET_NO                =:WK_PS_PO_NO_SUBSET_NO,
               PS_CUSTOMER_EDI_NO                =:WK_PS_CUSTOMER_EDI_NO,
               PS_CUSTOMER_IN_HOUSE_NO           =:WK_PS_CUSTOMER_IN_HOUSE_NO,
               PS_ASN_VENDOR_NO                  =:WK_PS_ASN_VENDOR_NO,
               PS_VENDOR_EDI_NO                  =:WK_PS_VENDOR_EDI_NO,
/*               PS_VENDOR_IN_HOUSE_NO             =:WK_PS_VENDOR_IN_HOUSE_NO,         */
               PS_DEL_TO_DC_NO                   =:WK_PS_DEL_TO_DC_NO,
               PS_DEL_TO_DC_IN_HOUSE_NO          =:WK_PS_DEL_TO_DC_IN_HOUSE_NO,
               PS_DEL_TO_STORE_NO                =:WK_PS_DEL_TO_STORE_NO,
/*------------------123456789012345678901234567890----123456789012345678901234567890----- */
               PS_DEL_TO_STORE_IN_HOUSE_NO       =:WK_PS_DEL_TO_STORE_IN_HSE_NO,
               PS_BILL_TO_PARTNER_NO             =:WK_PS_BILL_TO_PARTNER_NO,
               PS_BILL_TO_PARTNER_IN_HOUSE_NO    =:WK_PS_BILL_TO_PTNR_IN_HSE_NO,
               PS_CLASS_GROUP_DESC               =:WK_PS_CLASS_GROUP_DESC,
               PS_ADVERT_DATE_QLF                =:WK_PS_ADVERT_DATE_QLF,
               PS_ADVERTISED_DATE                =:WK_PS_ADVERTISED_DATE,
               PS_CANCEL_AFTER_DATE              =:WK_PS_CANCEL_AFTER_DATE,
               PS_PRODUCT_QUALIFIER              =:WK_PS_PRODUCT_QUALIFIER,
               PS_PRODUCT_CODE                   =:WK_PS_PRODUCT_CODE,
               PS_PRODUCT_GTIN                   =:WK_PS_PRODUCT_GTIN,
               PS_PRODUCT_DESC                   =:WK_PS_PRODUCT_DESC,
               PS_QTY_ORDERED                    =:WK_PS_QTY_ORDERED,
               PS_QTY_SHIPPED                    =:WK_PS_QTY_SHIPPED,
               PS_ORDERED_UOM                    =:WK_PS_ORDERED_UOM,
               PS_SALE_PRICE_CODE                =:WK_PS_SALE_PRICE_CODE,
               PS_SALE_PRICE                     =:WK_PS_SALE_PRICE,
               PS_SALE_IN_HOUSE_PRICE            =:WK_PS_SALE_IN_HOUSE_PRICE,
               PS_SALE_PRICE_VARIANCE            =:WK_PS_SALE_PRICE_VARIANCE,
               PS_LINE_COST                      =:WK_PS_LINE_COST,
               PS_SALE_RETAIL_PRICE              =:WK_PS_SALE_RETAIL_PRICE,
               PS_POS_KEY_CODE                   =:WK_PS_POS_KEY_CODE,
               PS_TOTAL_ORDER_AMOUNT             =:WK_PS_TOTAL_ORDER_AMOUNT,
               PS_TOTAL_ORDER_QTY                =:WK_PS_TOTAL_ORDER_QTY,
               PS_ORDERED_BY_UOM_GTIN            =:WK_PS_ORDERED_BY_UOM_GTIN,
               PS_ORDERED_BY_GTIN                =:WK_PS_ORDERED_BY_GTIN,
               PS_USE_BY_DATE                    =:WK_PS_USE_BY_DATE,
               PS_BATCH_NO                       =:WK_PS_BATCH_NO,
...
/*               PS_OUTER_BARCODE                  =:WK_PS_OUTER_BARCODE,            */
               PS_INNERS_PER_OUTER               =:WK_PS_INNERS_PER_OUTER,
               PS_ISSUES_PER_INNER               =:WK_PS_ISSUES_PER_INNER,
               PS_STORE_DEPT_NO                  =:WK_PS_STORE_DEPT_NO,
               PS_OTHER1                         =:WK_PS_OTHER1,
/*               PS_PACK_TYPE                      =:WK_PS_PACK_TYPE,               */
               PS_OTHER2                         =:WK_PS_OTHER2
               PS_LABEL_PRINTED_DATE             ='',         /* Updated by the DSPS Transaction later */
               PS_CREATE_DATE                    =:WK_DATE,
               PS_CREATED_BY                     =:WK_USER,
/*               PS_LAST_UPDATE_DATE               =:WK_PS_LAST_UPDATE_DATE,         */
/*               PS_LAST_UPDATE_BY               =:WK_PS_LAST_UPDATE_BY             */
         
               WHERE PS_SSCC = :WK_NEXT_PS_SSCC;
            END
            BEGIN
...
/*                /*   RETURNING_VALUES :WK_RESPONSE_TEXT ; <= '|PRINT_REQUEST.MESSAGE_ID=12345678|PRINT_REQUEST.REQUEST_STATUS=‘XQ’  */
            END
            SELECT WK_FIELD_TEXT FROM GET_REFERENCE_FIELD4 (:WK_RESPONSE_TEXT, 1, '|' ) INTO :WK_TRN_REF_STATUS;
            IF :WK_RESPONSE_TEXT = 'Processed successfully' THEN
            /* What do I test for so that I can construct WK_RESPONSE_FINAL ???   */
               BEGIN
                  WK_RESPONSE_FINAL = 'Processed successfully';
                  WK_RESPONSE_FINAL = WK_RESPONSE_FINAL ||  '|PICK_DESPATCH.DESPATCH_ID=' || :WK_DESPATCH_ID ;
                  WK_RESPONSE_FINAL = WK_RESPONSE_FINAL ||  '|PACK_SSCC.AWB_CONSIGNMENT_NO=' || :WK_CONSIGNMENT ;
