...
*/
     ...
     BEGIN
        ...
        END
        /* update item to PL PS or PC 
           PC only if line totally picked
        */
        IF (WK_PI_STATUS = 'PC') THEN
        BEGIN
        ...
        FOR SELECT PID.PICK_DETAIL_ID, PI.PICK_LINE_STATUS  
           ...
           WHERE PID.DEVICE_ID = :WK_DEVICE 
             ...
             AND PID.PICK_DETAIL_STATUS <> PI.PICK_LINE_STATUS
        ...
        BEGIN
           ...
           */
           ...
           FOR SELECT PID.PICK_DETAIL_ID, PI.PICK_LINE_STATUS  
              ...
              WHERE PID.DEVICE_ID = :WK_DEVICE 
                AND PID.PICK_DETAIL_STATUS = 'PL'
                AND PID.PICK_LABEL_NO = :WK_LABEL_NO
                AND PID.PICK_DETAIL_STATUS <> PI.PICK_LINE_STATUS
               INTO :WK_PID_ID, :WK_PI_STATUS2
           DO
           BEGIN
