/*
ALTER PROCEDURE ADD_SSN_ISSN_GRNV_WEIGHT (WH_ID VARCHAR(2) ,
*/

CREATE PROCEDURE ADD_SSN_ISSN_GRNV_WEIGHT (WH_ID VARCHAR(2) ,
LOCN_ID VARCHAR(10) ,
OBJECT VARCHAR(30) ,
...
*/
   ...
   BEGIN
       ...
       BEGIN
           WK_A_PROD = 1;
           WK_PROD_EXISTS = 0;
           SELECT 1, SHORT_DESC, PROD_TYPE FROM PROD_PROFILE
              WHERE PROD_ID = :OBJECT
              INTO :WK_PROD_EXISTS, :WK_PROD_DESC, :WK_PROD_TYPE;
           IF (WK_PROD_EXISTS = 0) THEN
           BEGIN
               /* Insert into prod_profile */
               INSERT INTO PROD_PROFILE (PROD_ID, SHORT_DESC, LAST_UPDATE_DATE)
