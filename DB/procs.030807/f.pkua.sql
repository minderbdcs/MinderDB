  ...
  BEGIN
     ...
     FOR 
        SELECT PICK_LABEL_NO, 
               ...
               INTO :WK_PI_LABEL, :WK_PI_PROD, :WK_PI_SSN, :WK_PI_STATUS
     DO
     BEGIN
/*
	must get
...
*/
        ...
        BEGIN
           ...
           WHERE ISSN.PROD_ID = :WK_PI_PROD 
             AND ISSN.WH_ID <> 'XX' AND ISSN.ISSN_STATUS IN ('RS','AL','ST','PA','PG','PL')
        ...
        WK_LABEL_LINE = 'UPDATE PICK_QTYS SET PICK_LINE_STATUS = ' ||
                SQUOTEDSTR(WK_PI_STATUS) || ' WHERE PICK_LABEL_NO = ' ||
                SQUOTEDSTR(WK_PI_LABEL );
        WK_RESULT = FILE_WRITELN(WK_FILENAME, WK_LABEL_LINE);
     END
