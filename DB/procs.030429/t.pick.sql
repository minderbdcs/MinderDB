...
SET GENERATOR PICK_LABEL_PREFIX TO 68^
SET GENERATOR PICK_LABEL_START TO 0^
SET GENERATOR PICK_LABEL_STOP TO 999999^
...
BEGIN
   ...
   WK_L_PICK_LABEL_NO = NEW.L_PICK_LABEL_NO ;
   WK_L_PICK_ORDER = NEW.L_PICK_ORDER ;
 ...
 WHERE PICK_ORDER = :WK_H_PICK_ORDER;
   END
   /* Check pick_item */
  IF (NEW.L_PICK_LABEL_NO IS NULL) THEN
  BEGIN
     ...
     BEGIN
	WK_PICK_ADJUSTMENT = WK_PICK_LABEL_START - WK_PICK_LABEL_START;
     ...
     END
     WK_LEN_LABEL_NO = STRLEN(WK_PICK_LABEL_NO) + 1;     
     /* Get Label prefix */      
     ...
     END
     WK_L_PICK_LABEL_NO = WK_L_PICK_LABEL_NO || WK_PICK_LABEL_NO;
  END
