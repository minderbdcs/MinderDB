...
CREATE PROCEDURE ADD_ISSN_LABEL ( WK_LABEL_PRINTER CHAR(2),
 WK_ISSN VARCHAR(20),
 WK_COPIES INTEGER,
 WK_USER VARCHAR(10),
 WK_LABEL_PREFIX  VARCHAR(20000))
RETURNS (WK_RESULT INTEGER, 
WK_ERROR_TEXT VARCHAR(1024))
AS 
BEGIN EXIT; END ^

ALTER  PROCEDURE ADD_ISSN_LABEL ( WK_LABEL_PRINTER CHAR(2),
 WK_ISSN VARCHAR(20),
 WK_COPIES INTEGER,
 WK_USER VARCHAR(10),
 WK_LABEL_PREFIX  VARCHAR(20000))
