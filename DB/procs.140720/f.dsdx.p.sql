...
*/
             ...
             BEGIN
                ...
                WK_RT_URI = NULL;
                SELECT PICK_ORDER.PERSON_ID, PICK_ORDER.COMPANY_ID
                FROM PICK_ORDER
                WHERE PICK_ORDER.PICK_ORDER  = :WK_ORDER
                INTO :WK_PO_PERSON_ID, :WK_PO_COMPANY_ID ;
                   ...
                   */
                   ...
                   BEGIN
                      ...
                      BEGIN
                         ...
                         WK_EMAIL_BUFFER = :WK_ORDER || '|' || :WK_PO_COMPANY_ID || '|' || :WK_CM_PS_REPORT_ID || '|' || :WK_RT_URI || '|' || :WK_PE_EMAIL || '|' || WK_CM_CC_EMAIL || '|PS';
                   ...
                   BEGIN
                      ...
                      BEGIN
                         ...
                         WK_EMAIL_BUFFER = :WK_ORDER || '|' || :WK_PO_COMPANY_ID || '|' || :WK_CM_PI_REPORT_ID || '|' || :WK_RT_URI || '|' || :WK_PE_EMAIL || '|' || WK_CM_CC_EMAIL || '|PI';
                         WK_EMAIL_RESULT = FILE_WRITELN(WK_EMAIL_FILENAME, :WK_EMAIL_BUFFER);
                      END
                      ELSE
                      BEGIN
                   ...
                   BEGIN
                      ...
                      BEGIN
                         ...
                         WK_EMAIL_BUFFER = :WK_ORDER || '|' || :WK_PO_COMPANY_ID || '|' || :WK_CM_TI_REPORT_ID || '|' || :WK_RT_URI || '|' || :WK_PE_EMAIL || '|' || WK_CM_CC_EMAIL || '|TI'  ;
                         WK_EMAIL_RESULT = FILE_WRITELN(WK_EMAIL_FILENAME, :WK_EMAIL_BUFFER);
                      END
                      ELSE
                      BEGIN
