...
/* 21/02/2014 always use the address from the sales order if there is one */
	...
	:WK_SO_FIRST_NAME, :WK_SO_LAST_NAME,
        ...
        :WK_ADDRESS_LINE2 , :WK_ADDRESS_LINE3 , :WK_ADDRESS_LINE4 ,
        :WK_ADDRESS_LINE5 )
...
/* select for passed dc and store here  - currently just select the first one 
==================================
*/
	...
	:WK_PIA_FIRST_NAME, :WK_PIA_LAST_NAME,
        ...
        :WK_PIA_ADDRESS_LINE2 , :WK_PIA_ADDRESS_LINE3 , :WK_PIA_ADDRESS_LINE4 ,
        :WK_PIA_ADDRESS_LINE5 )
        INTO WK_PD_ADDRESS_LINE1  , WK_PD_ADDRESS_LINE2  , WK_PD_ADDRESS_LINE3  ,
          WK_PD_ADDRESS_LINE4  , WK_PD_ADDRESS_LINE5  , WK_PD_ADDRESS_LINE6  ,
          WK_PD_ADDRESS_LINE7 ;
